...
public class SharedSD {
    ...
    public static AppiumDriver buildAppiumDriver() {
        ...
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Samsung Galaxy S7 - 6.0.0 - API 23 - 1440x2560");
        capabilities.setCapability(MobileCapabilityType.NO_RESET, false);
        capabilities.setCapability(MobileCapabilityType.APP, "/Users/mohammad/Downloads/base.apk");
